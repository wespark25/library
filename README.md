...
Now login with user. After loggin in select browse from the nav bar. Here you will see the books and authors you created. Choose some books and add them to your cart. Once you are satisfied with your book selection head to checkout. At checkout simply click the button at the bottom to proceed and add the books to your backpack.
